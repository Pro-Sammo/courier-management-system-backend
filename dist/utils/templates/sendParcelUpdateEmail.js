...
exports.sendParcelUpdateEmail = void 0;
const constants_1 = require("../miscellaneous/constants");
const sendParcelUpdateEmail = ({ customerName, trackingId, updateMessage, updatedAt, trackingLink, }) => {
    return `
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>${constants_1.PROJECT_NAME} - Parcel Update</title>
  </head>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; background: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 6px 12px rgba(0,0,0,0.06);">
            <tr>
              <td align="center" style="padding: 30px 20px 10px;">
                <img src="${constants_1.PROJECT_LOGO}" alt="${constants_1.PROJECT_NAME} Logo" style="width: 80px; margin-bottom: 10px;" />
            ...
            <tr>
              <td style="padding: 0 30px 20px;">
                ...
                <p style="font-size: 13px; color: #888; margin-top: 30px; text-align: center;">
                  ...
                  <a href="mailto:${constants_1.CUSTOMER_SUPPORT_EMAIL}" style="color: #1d72e8;">${constants_1.CUSTOMER_SUPPORT_EMAIL}</a>.
                </p>
              </td>
            </tr>
            <tr>
              <td style="background: #f8f9fb; padding: 15px; text-align: center; border-top: 1px solid #e1e7f0;">
                <p style="margin: 0; font-size: 12px; color: #aaa;">
                  &copy; ${new Date().getFullYear()} ${constants_1.PROJECT_NAME}. All rights reserved.
                </p>
              </td>
            </tr>
          </table>
...
exports.sendParcelUpdateEmail = sendParcelUpdateEmail;
